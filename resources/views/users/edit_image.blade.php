        ...
        <div class="col-md-11 col-lg-8">
            ...
            >
                ...
                <div class="form-group form-row justify-content-center">
                    {{-- 選択した画像のプレビュー表示 --}}
                    @if ($user->image !== '')
                        <img class="preview img-fluid image-preview-max-height" src="{{ \Storage::url($user->image) }}">
                    @else
                        <img class="preview img-fluid image-preview-max-height" src="{{ asset('images/profile_icon.png') }}">
                    @endif
                    <span class="pl-1 m-4">
