        ...
        <div class="col-md-11 col-lg-8">
            ...
            <form class="mt-3" method="POST" action="{{ route('posts.update', $post) }}">
                ...
                <div class="form-group form-row">
                    ...
                    <div class="col-md-10">
                        <input class="form-control count_flower_name @error('flower_name') is-invalid @enderror" id="flower_name" type="text" name="flower_name" placeholder="花の名前を入力してください" value="{{ $post->flower_name }}">
                        <div class="d-flex">
                            <div class="now_count_flower_name mr-1">0</div>
                            <div>/ 20文字</div>
                            <div class="ml-auto small text-secondary align-self-center">こちらの 花の名前 欄は未入力でも更新できます</div>
                        </div>
